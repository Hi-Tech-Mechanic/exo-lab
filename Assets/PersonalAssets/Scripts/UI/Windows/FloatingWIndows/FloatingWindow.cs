namespace ExoLab.UI
{
    ...
    public class FloatingWindow : DraggableElementAbstract, IPointerClickHandler
    {
        ...
        private const string headerComponentName = "Name";

        [SerializeField, Tooltip("An object in a prefab into which content is inserted.")]
        ...
        public void InitializeWindow(GameObject panel, string windowName)
        {
            ...
            var header = this.gameObject.TryGetChildWithName(headerComponentName);
