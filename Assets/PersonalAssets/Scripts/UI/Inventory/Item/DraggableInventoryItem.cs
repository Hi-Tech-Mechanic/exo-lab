namespace ExoLab.UI
{
    ...
    {
        private GameObject assemblyParent; //todo
        ...
        private void Awake()
        {
            assemblyParent = GameObject.FindGameObjectWithTag("GameController");
        ...
        public void OnEndDrag(PointerEventData eventData)
        {
            ...
            if (this.transform.position.x > 800) // todo временно
            {
                if (this.Item.ItemData.object3dModel != null && assemblyParent.activeInHierarchy == true)
                    Instantiate(this.Item.ItemData.object3dModel, assemblyParent.transform);
            }
