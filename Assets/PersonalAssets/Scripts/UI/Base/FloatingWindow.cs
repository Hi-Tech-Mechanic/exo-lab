...
/// <summary>
/// Плавающее окно которое можно перемещать,
/// является оберткой для другого окна или панели
/// </summary>
public class FloatingWindow : DraggableElementAbstract, IPointerClickHandler
{
    ...
    /// <summary>
    /// Вставить контент в обертку данного окна
    /// </summary>
    ...
    public override void OnDrag(PointerEventData eventData)
    {
        if (this.canvas != null)
        {
            // Преобразуем смещение в пространство Canvas
